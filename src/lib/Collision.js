...
class Capsule {
	...
	lineLineMinimumPoints( line1, line2 ) {
		...
		const s = capsule_v2.copy( line2.end ).sub( line2.start )
		const w = capsule_v3.copy( line2.start ).sub( line1.start )
...
const capsule_v1 = new Vector3()
const capsule_v2 = new Vector3()
const capsule_v3 = new Vector3()
